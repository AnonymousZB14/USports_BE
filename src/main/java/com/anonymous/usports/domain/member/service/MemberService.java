...
public interface MemberService {
   ...
   * 회원 계정 이름 확인
   */
  String checkAccountName(String accountName);
   ...
   * 회원 삭제
   */
  MemberWithdraw.Response deleteMember(MemberDto memberDto, MemberWithdraw.Request request,
      Long memberId);
   ...
   * 프로필 이미지 변경
   */
  MemberResponse updateMemberProfileImage(MultipartFile profileImage, MemberDto memberDto,
      Long memberId);
   ...
   * 회원 비밀번호 수정
   */
  PasswordUpdate.Response updatePassword(PasswordUpdate.Request request, Long id,
      MemberDto memberDto);
